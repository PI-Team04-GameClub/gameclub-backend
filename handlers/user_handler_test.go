...
func TestUserHandler_CreateUser_Success_Unit(t *testing.T) {
	...
	// When: Making the create user request
	resp, err := app.Test(req)
...
func TestUserHandler_CreateUser_InvalidJSON_Unit(t *testing.T) {
...
func TestUserHandler_CreateUser_MissingRequiredFields_Unit(t *testing.T) {
...
func TestUserHandler_CreateUser_PasswordTooShort_Unit(t *testing.T) {
	// Given: A request with a password that is too short
	mockUserRepo := new(mocks.MockUserRepository)
	handler := NewUserHandlerWithRepo(mockUserRepo)
...
func TestUserHandler_CreateUser_EmailAlreadyExists_Unit(t *testing.T) {
	...
	existingUser := &models.User{Model: gorm.Model{ID: 1}, Email: "john@example.com"}
	mockUserRepo.On("FindByEmail", mock.Anything, "john@example.com").Return(existingUser, nil)
...
func TestUserHandler_CreateUser_DatabaseError_Unit(t *testing.T) {
	// Given: A database error occurs when creating user
	mockUserRepo := new(mocks.MockUserRepository)
	handler := NewUserHandlerWithRepo(mockUserRepo)
	...
	mockUserRepo.On("FindByEmail", mock.Anything, "john@example.com").Return(nil, gorm.ErrRecordNotFound)
	mockUserRepo.On("Create", mock.Anything, mock.AnythingOfType("*models.User")).Return(errors.New("database error"))
...
func TestUserHandler_DeleteUser_Success_Unit(t *testing.T) {
	// Given: A user exists with the specified ID
	mockUserRepo := new(mocks.MockUserRepository)
	handler := NewUserHandlerWithRepo(mockUserRepo)
...
func TestUserHandler_DeleteUser_NotFound_Unit(t *testing.T) {
	// Given: No user exists with the specified ID
	mockUserRepo := new(mocks.MockUserRepository)
	handler := NewUserHandlerWithRepo(mockUserRepo)
...
func TestUserHandler_DeleteUser_InvalidID_Unit(t *testing.T) {
	// Given: An invalid user ID is provided
	mockUserRepo := new(mocks.MockUserRepository)
	handler := NewUserHandlerWithRepo(mockUserRepo)
...
func TestUserHandler_DeleteUser_DatabaseError_Unit(t *testing.T) {
	// Given: A user exists but database error occurs during delete
	mockUserRepo := new(mocks.MockUserRepository)
	handler := NewUserHandlerWithRepo(mockUserRepo)
	...
	existingUser := &models.User{Model: gorm.Model{ID: 1}, FirstName: "John", Email: "john@example.com"}
	mockUserRepo.On("FindByID", mock.Anything, uint(1)).Return(existingUser, nil)
	mockUserRepo.On("Delete", mock.Anything, uint(1)).Return(errors.New("database error"))
